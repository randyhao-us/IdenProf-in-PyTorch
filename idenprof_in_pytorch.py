...
# train model which can accept different model and optimizer
...
# call the pretrained ResNet18 model
...
# Code to test model accuracy with the image in test dataset
